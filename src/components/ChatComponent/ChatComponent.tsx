    ...
    <>
      ...
      >
        ...
        >
          ...
          {(props.messages.length == 0 || props.curr_group_id == -1) ? <ChatBubble name="" avatar="" is_curr_user={false} message_time="" key="" start_animation={false} is_server={true}>Start by creating or joining a group!</ChatBubble> : ""}
        </div>
